...
export const ja = {
  ...
  briefing: {
    ...
    rules: [
      ...
      /*
       * 撃ち合いの向きは**遊び方と区画のどこかで変わる。**ここでは言わない。
       *
       * 長らく「撃たれている者ほど、本当のことを言っている」と書いていたが、
       * 実測（tools/shot-probe.mjs）ではそれが本当なのは崖っぷちの区画の奥だけで、
       * 通常と全員挑戦者では**どの部屋でも逆**だった。手引きが嘘をついていた。
       *
       *   撃たれた者が正解を口にしていた割合 − 撃たれていない者
       *     通常        1部屋目 -33.9pt  …  5部屋目  -9.6pt
       *     崖っぷち    1部屋目  -8.8pt  …  5部屋目 +30.0pt（2部屋目で向きが変わる）
       *     全員挑戦者  1部屋目 -35.7pt  …  5部屋目 -42.5pt
       *
       * 向きは遊び方ごとの節に書く。
       */
      '助言者が互いを撃つ理由は遊び方で違う。撃たれている者を信じるか疑うかは、遊び方ごとの欄に書いてある。',
    ...
    modes: {
      standard: [
        ...
        // 実測 -33.9pt（1部屋目）〜 -9.6pt（5部屋目）。半分は正直者なので、
        // 撃つ側の多くは「自分の見立てに無い扉を押す者」を撃っている
        '撃たれている者は、たいてい外れた扉を押している。正直者も、自分の見立てに無い扉を押す者を撃つからだ。',
      ],
      brink: [
        ...
        // 実測 -8.8pt（1部屋目）→ +30.0pt（5部屋目）。2部屋目から本当になる
        '区画の奥では、撃たれている者ほど本当のことを言っている。嘘つきはただ一人の正直者へ群がるしかないからだ。',
        'ただし序盤は逆を向く。信用を作っている最中の嘘つきは仲間の顔で撃つので、そこで撃たれているのは罠を押している側だ。',
      ],
      party: [
        ...
        // 実測 -35.7pt 〜 -42.5pt。裏切り者は罠しか知らないので、撃つ先が揃う
        '撃たれている者は、たいてい罠を押している。裏切り者は正解を知らず、罠だけを知っているからだ。',
      ],
    },
  },
