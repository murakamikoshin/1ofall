...
export const en: Strings = {
  ...
  advisor: {
    ...
    careerHead: 'Your record here',
    careerSpoke: (followed: number, spoke: number) => `Spoke in ${spoke} rooms, taken in ${followed}`,
    careerOutcome: (killed: number, saved: number) => `Killed them in ${killed} rooms, saved them in ${saved}`,
    careerBet: (hit: number, all: number) => `Bets ${hit} of ${all} right`,
    careerRole: (liar: number, all: number) => `Liar in ${liar} of ${all} sections`,
    careerDoubted: (n: number) => `Doubted in ${n} rooms`,
